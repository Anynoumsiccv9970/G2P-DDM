...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--num_workers', type=int, default=64, help='')

        self.parser.add_argument('--init_lr', type=float, default=1e-4, help='')
        self.parser.add_argument('--use_lr_schedule', action='store_true', help='use_lr_schedule')

        # input/output sizes
               
        self.parser.add_argument('--resume_ckpt', type=str, default="", help='')
        self.parser.add_argument('--max_frames_num', type=int, default=300, help='')
