...
class PoseVQVAE(pl.LightningModule):
    def __init__(self, args, text_dict):
        ...
        self.codebook = Codebook(n_codes=args.n_codes, embedding_dim=args.embedding_dim)
        ...
        # from backmodels.point2text_model_cnn import BackTranslateModel as BackTranslateModel1
        # from backmodels.point2text_model import BackTranslateModel as BackTranslateModel2
    ...
    def vqvae_encode(self, points, points_mask):
        ...
        return vq_tokens, points_feat, commitment_loss, vq_tokens
