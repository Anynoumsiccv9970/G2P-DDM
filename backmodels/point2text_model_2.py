...
class BackTranslateModel(pl.LightningModule):
    def __init__(self, args, text_dict):
        ...
        self.conv1 = nn.Sequential(nn.Conv1d(512, 512, kernel_size=5, stride=1, padding=2), 
                                   nn.BatchNorm1d(512), 
                                   nn.LeakyReLU(),
                                   nn.MaxPool1d(2, 2),
        ...
        self.conv2 = nn.Sequential(nn.Conv1d(512, 1024, kernel_size=3, stride=1, padding=1), 
                                   nn.BatchNorm1d(1024))
    ...
    def forward(self, points, skel_len, word_tokens, word_len, mode):
        ...
        points = self.conv1(points) # b h t/4
